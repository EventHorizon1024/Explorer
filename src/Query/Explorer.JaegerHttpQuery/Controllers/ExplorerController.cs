...
using AutoMapper;
using Explorer.JaegerHttpQuery.DTOs;
using Explorer.JaegerHttpQuery.DTOs.Request;
using Explorer.JaegerHttpQuery.DTOs.Response;
using Explorer.Models;
using Explorer.Storage.Abstractions;
using Microsoft.AspNetCore.Mvc;
using Newtonsoft.Json;

namespace Explorer.JaegerHttpQuery.Controllers
{
    [Route("/api")]
